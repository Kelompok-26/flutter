  ...
  Widget build(BuildContext context) {
    ...
    body: ListView(
      ...
      children: [
        ...
        const Text('Kebijakan Privasi C-Loyal', style: TextStyle( 
          fontSize: 20, 
      ...
      const Padding(padding: EdgeInsets.only(top: 20)),
        const Text('Apa aja yang diatur dalam kebijakan ini?', style: TextStyle( 
          fontSize: 20, 
          fontWeight: FontWeight.w800, 
          color: Colors.black,
        ),), 
      ...
      const Padding(padding: EdgeInsets.only(top: 20)),
        const Text('Informasi yang C-Loyal kumpulkan', style: TextStyle( 
          fontSize: 20, 
          fontWeight: FontWeight.w800, 
          color: Colors.black,
        ),), 
        ...
        const Padding(padding: EdgeInsets.only(top: 20)),
        const Text('Informasi yang C-Loyal tidak kumpulkan', style: TextStyle( 
          fontSize: 20, 
          fontWeight: FontWeight.w800, 
          color: Colors.black,
        ),), 
        ...
        const Padding(padding: EdgeInsets.only(top: 20)),
        const Text('Perubahan dan Pemutahiran atas Kebijakan Privasi', style: TextStyle( 
          fontSize: 20, 
          fontWeight: FontWeight.w800, 
          color: Colors.black,
        ),), 
